            ...
            <div className="flex flex-col gap-6">
              ...
              <label className="flex flex-col w-full">
                ...
                <div className="relative flex w-full items-center">
                  <svg className="absolute left-3 w-6 h-6 text-[#92adc9]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <label className="flex flex-col w-full">
                ...
                <div className="relative flex w-full items-center">
                  ...
                  <button
                      ...
                      type="button"
                      className="absolute right-3 text-[#92adc9] hover:text-white"
                  >
                    {showPassword ? (
